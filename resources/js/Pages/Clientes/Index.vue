    ...
    <div class="mx-auto flex max-w-3xl flex-col gap-4">
        ...
        <div v-else class="rounded-lg border border-gray-200 bg-white shadow-sm">
            <table class="w-full table-fixed text-left text-sm">
                <colgroup>
                    <col />
                    <col class="hidden md:table-column md:w-[140px]" />
                </colgroup>
                <thead class="bg-gray-100 text-xs uppercase text-kredix-gris">
                    <tr>
                        <th class="px-2 py-2">Nombre</th>
                        <th class="hidden px-2 py-2 md:table-cell">Telefono</th>
                    </tr>
                </thead>
                <tbody>
                    <tr
                    ...
                    >
                        <td class="break-words px-2 py-2 font-medium text-kredix-negro">
                            {{ cliente.nombre }}
                            <span class="block text-xs font-normal text-kredix-gris md:hidden">{{ formatPhoneDisplay(cliente.telefono) }}</span>
                        </td>
                        <td class="hidden truncate px-2 py-2 text-kredix-gris md:table-cell">{{ formatPhoneDisplay(cliente.telefono) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
